...
class ColorControl(wx.Control):
    ...
    def onPaint(self, event):
        ...
        if ColorControl.nonePen == False:
            ...
            ColorControl.selectPen =  gc.CreatePen(wx.Pen(
                wx.Colour(150,150,150,255), 1, wx.SOLID))
...
class ColorDisplay(wx.Window):
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, 
            size=(80,60), style=wx.NO_BORDER, name="ColorPicker"):
...
class ColorPicker(wx.Window):
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, 
        ...
        self.reds[15].rightx = self.greens[15].right=self.blues[15].right=True
...
class DrawControl(wx.Control):
    ...
    def __init__(self, parent, imageSize=(64,64), color=(255,255,255,255), 
            ...
            style=wx.ALWAYS_SHOW_SB, validator=wx.DefaultValidator,
                    name="DrawControl"):
...
class DrawWindow(wx.ScrolledWindow):
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, 
            size=(800,600), style=wx.ALWAYS_SHOW_SB, name="DrawWindow"):
...
class MainWindow(wx.Frame):
    ...
    def OnAbout(self, e):
        ...
        dlg = wx.MessageDialog(self, " A Pixel Aet Editor \n in wxPython", 
